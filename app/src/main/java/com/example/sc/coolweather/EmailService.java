...
public class EmailService extends Service {
    ...
    private StringBuffer emailContacts;

    private int thirtySeconds = 10 * 60 * 1000;
    ...
    public void onCreate() {
        ...
        emailContacts = new StringBuffer();
        emailContacts.append(prefs.getString("emailContacts", ""));
    }
    ...
    class MyBinder extends Binder{
        ...
        public void stopService() {
            ...
            Intent i = new Intent(EmailService.this, EmailService.class);
            PendingIntent pi = PendingIntent.getService(EmailService.this, 0, i, 0);
            manager.cancel(pi);
        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        try {
            if (currentLocation != null) {
                currentLocation.append("\n").append("下一封位置邮件将在十分钟后收到");
                for (String singleEmailContact : emailContacts.toString().split(" ")) {
                    if (!singleEmailContact.equals("")) {
                        Log.d("EamilService", "sent");
                        emailSender.sendEmail(singleEmailContact, currentLocation.toString());
                    }
                }
            }
        ...
        Log.d("EmailService", "service running");

        Intent i = new Intent(this, EmailService.class);
        PendingIntent pi = PendingIntent.getService(this, 0, i, 0);
        manager = (AlarmManager) getSystemService(ALARM_SERVICE);
        long triggerAtTime = SystemClock.elapsedRealtime() + thirtySeconds;
    ...
    private class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            Log.i("BaiduLocationApiDem", currentLocation.toString());
        }
